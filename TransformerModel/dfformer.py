...
from test1 import DSFE
# #from test2 import GatedCNNBlock
# from test6 import GGCA
# from test4 import LKA_Attention
...
class MetaFormer(nn.Module):
    ...
    def __init__(self,hash_bit=64,in_chans=3,num_classes=1000,
                 depths=[2, 2, 6, 2],
                 dims=[64, 128, 320, 512],

                 hs=[56, 28, 14, 7],
                 ws=[56, 28, 14, 7],
                 input_sizes=[3136, 784, 196, 49],
        ...
        if not isinstance(input_sizes, (list, tuple)):
            input_sizes = [input_sizes] * num_stage
...
@register_model
def dfformer_s18(pretrained=True, **kwargs):
